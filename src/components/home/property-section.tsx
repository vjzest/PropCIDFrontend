        ...
        <table className="min-w-full bg-white">
          ...
          <tbody>
            {properties.slice(0, 4).map((property) => (
              <tr
                key={property._id}
                className="hover:bg-neutral-50 cursor-pointer border-b"
                onClick={() => setSelectedProperty(property)}
              >
                <td className="p-3">
                  <img src={property.images} alt={property.title} className="w-16 h-12 object-cover rounded" />
                </td>
                <td className="p-3 font-semibold">{property.title}</td>
                <td className="p-3">{property.owner}</td>
                <td className="p-3">{property.location}</td>
                <td className="p-3 text-primary font-bold">{property.price}</td>
                <td className="p-3">{property.beds}</td>
                <td className="p-3">{property.baths}</td>
